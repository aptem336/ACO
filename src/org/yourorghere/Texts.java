...
public class Texts {
    ...
    public static int rightPadding = 325;

    public static String text1 = "SPACE - stop/start calc";
    public static String text2 = "ESC - clear all";
    public static String text3 = "SHIFT - show/hide pheromone level";
    public static String text4 = "CONTROL - show/hide best chain";
